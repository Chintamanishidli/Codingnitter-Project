            ...
            <?php foreach ($selected_plan as $value): ?>
                <div class="col-sm-8 col-md-4 ml-auto mr-auto">
                    <?php if ($value->plan_id == 1) {
                        $package_class = "text-line-through";
                    } else {
                    ...
                    <div class="feature feature--boxed-border feature--bg-2 active package_bg mt-4">
                        <div class="icon-block--style-1-v5 text-center">
                            ...
                            <div class="block-content">
                                ...
                                <h3 class="price-tag"><sup style="font-size: 36px;"></sup><?= currency($value->total_amount) ?></h3>
                                <ul class="pl-0 pr-0 mt-0">
                                    <li class="package_items"><?php if ($value->plan_id == 1) {
                                                                    echo "Limited Profile Searching";
                                                                } else {
                                                                    echo "Advanced Profile Searching";
                                                                } ?></li>

			...
			<div class="panel-body">
				<form class="form-horizontal" id="manage_details_form" method="POST" action="<?= base_url() ?>admin/admins/do_add">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" value="<?php if (!empty($form_contents)) {
																															...
																															} ?>" name="name" placeholder="<?= translate('staff_name') ?>">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" value="<?php if (!empty($form_contents)) {
																															...
																															} ?>" name="email" placeholder="<?= translate('staff_email') ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" value="<?php if (!empty($form_contents)) {
																															...
																															} ?>" name="phone" placeholder="<?= translate('staff_phone_no.') ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea class="form-control" name="address" placeholder="<?= translate('staff_address') ?>"><?php if (!empty($form_contents)) {

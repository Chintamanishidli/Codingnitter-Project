						...
						<form class="form-horizontal" id="package_form" method="POST" action="<?= base_url() ?>admin/packages/update" enctype="multipart/form-data">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-1">
										<input id="exp_int_status" name="exp_int_status" class="magic-checkbox checkbox" type="checkbox" <?php if ($value->exp_int_status == 1) {
																																																												echo 'checked';
																																																											} ?>>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-1">
										<input id="dir_msg_status" name="dir_msg_status" class="magic-checkbox checkbox" type="checkbox" <?php if ($value->dir_msg_status == 1) {
																																																												echo 'checked';
																																																											} ?>>
									</div>
								</div>

                        ...
                        <?php if ($this->Crud_model->admin_permission('members')) { ?>
                            <li <?php if (in_array($page_name, ['free_members', 'premium_members', 'national_members', 'ngb_members', 'guest_members', 'deleted_member', 'add_member', 'bulk_member_add', 'member_profile_pic_approval'])) echo 'class="active-sub active"'; ?>>
                                ...
                                <ul class="collapse">
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('guest_members')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('ngb_members')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('national_members')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('premium_members')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('add_members')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('bulk_member_add')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('deleted_members')) { ?>
                        ...
                        <?php if ($this->Crud_model->admin_permission('frontend_settings')) { ?>
                            <li <?php if (in_array($page_name, ['header', 'pages', 'footer', 'theme_color_settings'])) echo 'class="active-sub active"'; ?>>
                                ...
                                <ul class="collapse">
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('frontend_appearances')) { ?>
                                        <li <?php if (in_array($page_name, ['header', 'pages', 'footer'])) echo 'class="active-sub active"'; ?>>
                                            ...
                                            <ul class="collapse">
                                                ...
                                                <?php }
                                                if ($this->Crud_model->admin_permission('pages')) { ?>
                                                ...
                                                <?php }
                                                if ($this->Crud_model->admin_permission('footer')) { ?>
                        ...
                        <?php if ($this->Crud_model->admin_permission('configuration')) { ?>
                            <li <?php if (in_array($page_name, ['religion', 'caste', 'sub_caste', 'language', 'country', 'state', 'city', 'family_value', 'family_status', 'payments', 'social_media_comments', 'faq', 'email_setup', 'captcha_settings', 'social_media_login', 'google_analytics_settings', 'facebook_chat_settings', 'msg91', 'twilio', 'on_behalf', 'currency_configure', 'currency_set', 'profile_sections'])) echo 'class="active-sub active"'; ?>>
                                ...
                                <ul class="collapse">
                                        ...
                                        <li <?php if (in_array($page_name, ['religion', 'caste', 'sub_caste', 'language', 'country', 'state', 'city', 'family_value', 'family_status', 'on_behalf'])) echo 'class="active-sub active"'; ?>>
                                            ...
                                            <ul class="collapse">
                                                <?php if ($this->db->get_where('frontend_settings', ['type' => 'spiritual_and_social_background'])->row()->value == "yes") { ?>
                                                    ...
                                                    <?php } ?>
                                                <?php }
                                                if ($this->db->get_where('frontend_settings', ['type' => 'language'])->row()->value == "yes") { ?>
                                                    ...
                                                    <?php } ?>
                                                <?php }
                                                if ($this->db->get_where('frontend_settings', ['type' => 'present_address'])->row()->value == "yes") { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('profile_sections')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('social_media_comments')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('email_setup')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('currency_settings')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('captcha_settings')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('social_media_login_settings')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('google_analytics_settings')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('facebook_chat_settings')) { ?>
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('sms_settings')) { ?>
                        ...
                        <?php if ($this->Crud_model->admin_permission('staffs_panel')) { ?>
                            <li <?php if (in_array($page_name, ['role', 'admin'])) echo 'class="active-link"'; ?>>
                                ...
                                <ul class="collapse <?php if (in_array($page_name, ['admin', 'role'])) echo 'in'; ?>">
                                    ...
                                    <?php }
                                    if ($this->Crud_model->admin_permission('manage_roles')) { ?>
